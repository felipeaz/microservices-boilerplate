...
func (_m *Repository) Remove(ctx context.Context, id uuid.UUID) (*domain.ItemA, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Repository) Update(ctx context.Context, id uuid.UUID, item domain.ItemA) (*domain.ItemA, error) {
	ret := _m.Called(ctx, id, item)

	var r0 *domain.ItemA
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, domain.ItemA) *domain.ItemA); ok {
		r0 = rf(ctx, id, item)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*domain.ItemA)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, domain.ItemA) error); ok {
		r1 = rf(ctx, id, item)
	} else {
		r1 = ret.Error(1)
	}
