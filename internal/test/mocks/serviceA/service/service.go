...
func (_m *Service) GetAll(ctx context.Context) ([]*domain.ItemB, error) {
	ret := _m.Called(ctx)
...
func (_m *Service) GetOneByID(ctx context.Context, id uuid.UUID) (*domain.ItemB, error) {
	ret := _m.Called(ctx, id)
...
func (_m *Service) Update(ctx context.Context, id uuid.UUID, item domain.ItemB) error {
